...
Write a Python script called student_info.py that collects personal information from the user and displays it in a formatted profile card.
The program must demonstrate correct use of all four data types, string manipulation, arithmetic, and the f-string output format.

## Requirements
- Use input() to collect: first name, surname, age (as an integer), and a favourite number (as a float)
- Display a formatted greeting using an: 
f-string: ‘Welcome, [Full Name]!’
...
Before progressing to the next unit, complete the Unit 1 Quiz to check your understanding of the key concepts covered, identify any areas that may need further practice, and reinforce your learning.
